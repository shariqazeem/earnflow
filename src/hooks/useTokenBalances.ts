...
const TOKEN_MAP: Record<number, { symbol: string; name: string; address: `0x${string}`; decimals: number; icon: string }[]> = {
  ...
  42161: [
    ...
    { symbol: "WETH", name: "Wrapped ETH", address: "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1", decimals: 18, icon: "◆" },
  ],
  // Base
  8453: [
    ...
    { symbol: "WETH", name: "Wrapped ETH", address: "0x4200000000000000000000000000000000000006", decimals: 18, icon: "◆" },
  ],
  // Optimism
  10: [
